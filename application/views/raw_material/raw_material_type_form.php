                        ...
                        <div class="box box-body">
                            <div class="row">
                                <div class="col-sm-6">
                                 ...
                                 <div class="col-sm-6">
                                     <a href="<?=base_url('view/raw_material_type')?>" class="btn pull-right btn-sm btn-primary">View All</a>
                                 </div>
                             </div> 
                            ...
                            <div class="row">
                              <div class="col-sm-10">   
                            <?php
                                    echo form_open('new_add/new_material_type', array('class'=>'form form-horizontal'));
