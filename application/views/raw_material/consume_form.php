<?php  $this->load->view('inc/header'); ?>
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="#">Material Consume</a></li>
                </ol>
            </section>
            ...
            <section class="content">
                <div class="row">
                            ...
                            <div class="col-xl-12 col-12 pr-0">
                                ...
                                <div class="box box-body">
                                    ...
                                    <div class="row">
                                      <div class="col-sm-10">   
                                    <?php
                                            echo form_open('new_add/raw_material_consume', array('class'=>'form form-horizontal'));
                    ...
                    <div class="col-sm-12">
                       <div class="box box-body">
                         <table id="consume_table" class="display table table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>Date</th>
                                        <th>Material Name</th>
