...
<section class="content">
    <div class="row">
        ...
        <div class="col-xl-12 col-12 pr-0">
          <div class="row">
               <div class="col-sm-12"><a href="<?=base_url()?>new_add/customer_payment" class="btn btn-info pull-right">Add Payment</a></div>
            ...
            <div class="col-sm-12">
             <div class="box box-default">
              ...
              <!-- Tab panes -->
                    ...
                    <h3>All Payments</h3>
                      <table class="table" id="customer_paymets_table">
                        <thead>
                          <tr>
                            <th>Buyer</th>
                            <th>Date</th>
...
<script>
   var customer_paymets_table='';
$(document).ready(function(){

  
  customer_paymets_table =  $('#customer_paymets_table').DataTable({
      'ajax': url+'view/customer_paymets_table'
   });
     ...
     swal({ 
             ...
             closeOnCancel: true ,
               showLoaderOnConfirm: true
                 ...
                 if (isConfirm) {
                            $.post(url+'delete/delete_buyer_payments',{ payment_id:dataId},function(obj){
                                    
                                     if(obj.rs== '1'){
                                     swal("Success!", obj.msg, "success"); 
                                           customer_paymets_table.ajax.reload();
                                     }else{
     ...
     swal({ 
             ...
             closeOnCancel: true ,
               showLoaderOnConfirm: true
                 ...
                 if (isConfirm) {
                            $.post(url+'report/verify_buyer_payments',{ payment_id:dataId},function(obj){
