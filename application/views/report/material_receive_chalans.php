            ...
            <div class="col-sm-12">
             <div class="box box-default">
                  ...
                  <div class="box-body">
                    ...
                    <h3> Raw Materials</h3>
                      <table class="table" id="material_chalan_table">
                        <thead>
                          <tr>
                            <th>Chalan Date</th>
                            <th>Chalan No</th>
...
<script>
   var material_chalan_table='';
$(document).ready(function(){

  
  material_chalan_table =  $('#material_chalan_table').DataTable({
      'ajax': url+'view/material_chalan_table'
   });
