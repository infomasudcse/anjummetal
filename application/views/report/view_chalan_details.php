             ...
             <div class="box box-default">
                  ...
                  <div class="box-body">
                     <div class="row">
                        <div class="col-sm-12">
                          <?php  
                          $chalan = $this->db->where('chalan_no',$chalan_no)->get('raw_material_chalan')->row_array();
                                  ...
                                  if($items->num_rows()>0){
                                    ...
                                    $i=1;
                                      foreach($items->result_array() as $item){
                                        ...
                                        echo '<tr>';
                                        echo '<td>'.$i.'</td>';
                                        echo '<td>'.get_material_type_name($item['material_id']).'</td>';
