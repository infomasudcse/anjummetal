            ...
            <div class="col-sm-12">
             <div class="box box-default">
                  ...
                  <div class="box-body">
                    ...
                    <h3> Accessories Chalans</h3>
                      <table class="table" id="accessories_chalan_table">
                        <thead>
                          <tr>
                            <th>Chalan Date</th>
                            <th>Chalan No</th>
...
<script>
   var accessories_chalan_table='';
$(document).ready(function(){

  
  accessories_chalan_table =  $('#accessories_chalan_table').DataTable({
      'ajax': url+'view/accessories_chalan_table'
   });
     ...
     swal({ 
             ...
             closeOnCancel: true ,
               showLoaderOnConfirm: true
                 ...
                 if (isConfirm) {
                            $.post(url+'report/verify_accessories_chalan',{ chalan_id:dataId},function(obj){
                                    
                                     if(obj.rs== '1'){
                                     swal("Success!", obj.msg, "success"); 
                                           accessories_chalan_table.ajax.reload();
                                     }else{
