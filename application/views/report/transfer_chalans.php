            ...
            <div class="col-sm-12">
             <div class="box box-default">
              ...
              <!-- Tab panes -->
                    ...
                    <h3> Transfer Chalans</h3>
                      <table class="table" id="transfer_chalan_table">
                        <thead>
                          <tr>
                            <th>FROM </th>
                            <th>TO</th>
...
<script>
   var transfer_chalan_table='';
$(document).ready(function(){

  
  transfer_chalan_table =  $('#transfer_chalan_table').DataTable({
      'ajax': url+'view/transfer_chalan_table'
   });
     ...
     swal({ 
             ...
             closeOnCancel: true ,
               showLoaderOnConfirm: true
                 ...
                 if (isConfirm) {
                            $.post(url+'report/verify_transfer_chalan',{ chalan_id:dataId},function(obj){
                                    
                                     if(obj.rs== '1'){
                                     swal("Success!", obj.msg, "success"); 
                                           transfer_chalan_table.ajax.reload();
                                     }else{
