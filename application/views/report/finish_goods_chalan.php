            ...
            <div class="col-sm-12">
             <div class="box box-default">
              ...
              <!-- Tab panes -->
                    ...
                    <h3> Finish Goods Chalans</h3>
                      <table class="table" id="finish_goods_chalan_table">
                        <thead>
                          <tr>                           
                            <th>Chalan Date</th>
                            <th>Chalan No</th>                           
...
$(document).ready(function(){
  ...
  finish_goods_chalan_table =  $('#finish_goods_chalan_table').DataTable({
      'ajax': url+'view/finish_goods_chalan_table'
   });
     ...
     swal({ 
             ...
             closeOnCancel: true ,
               showLoaderOnConfirm: true
                 ...
                 if (isConfirm) {
                            $.post(url+'report/verify_finish_goods_chalan',{ chalan_id:dataId},function(obj){
                                    
                                     if(obj.rs== '1'){
                                     swal("Success!", obj.msg, "success"); 
                                           finish_goods_chalan_table.ajax.reload();
                                     }else{
