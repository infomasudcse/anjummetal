                                ...
                                <div class="col-sm-12">
                                  ...
                                  <div class="box box-body">
                                    ...
                                    <?php
                                            ...
                                            echo form_open('workstationtwo/select_acc_supplier', array('class'=>'form form-horizontal' ,'id'=>'final_form'));
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <label for="buyerSelect" class="col-sm-2 col-form-label">Select Supplier</label>
                                    ...
                                    <div class="form-group row">
                                      ...
                                      <div class="col-sm-4">
                                            ...
                                            <button type="button" class="btn btn-primary" id="submit_btn">Finish</button>
