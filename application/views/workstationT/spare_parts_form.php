  ...
  <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-sm-6">
          ...
          <div class="box box-body">
           ...
           echo form_open('workstationtwo/spare_parts', array('class'=>'form form-horizontal'));
    ...
    <div class="col-sm-6">
     ...
     <div class="box box-body">
      ...
      <?php echo form_open('workstationtwo/update_parts_cart');  ?>
      ...
      <p>
        ...
        <a href="<?=base_url()?>workstationtwo/createSparePartsChalan" class="btn btn-success pull-right" >Proceed...</a>
      </p>
