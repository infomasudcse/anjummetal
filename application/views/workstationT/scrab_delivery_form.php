<?php  $this->load->view('workstationtwo/inc/header'); ?>
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="#">Scrab</a></li>
                                  ...
                                  <div class="box box-body">
                                     ...
                                     <h3>Scrab</h3>
                                      ...
                                      <?php
                                            ...
                                            echo form_open('workstationtwo/delivery_scrab', array('class'=>'form form-horizontal'));
                             ...
                             <div class="form-group row">
                                 ...
                                 <div class="col-sm-6">
                                     ...
                                     <div class="box box-body">
                                          ...
                                          <h3>Item In chalan</h3>

                                          <?php echo form_open('workstationtwo/update_scrab_cart');  ?>
                                            ...
                                            <p>
                                              <?php echo form_submit('', 'Update Memo', array('class'=>'btn btn-warning')); ?>
                                                <a href="<?=base_url()?>workstationtwo/scarb_chalan_input" class="btn btn-success pull-right" >Proceed...</a>
                                              </p>
