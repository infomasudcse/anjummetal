...
<body class="hold-transition skin-red-light sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="<?=base_url('workstationthree')?>" class="logo">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                  ...
                  <!--  <li class="">
                        <a href="base_url('workstationthree/receive_finish_goods')">
                            <i class="fa fa-th"></i><span>Receive Finish Goods</span>                            
                        </a>
                    </li> -->
                    
                     <li class="<?=(($title=='Sale')?'active':'')?>">
                        <a href="<?=base_url('workstationtwo/sale_product')?>">
                            <i class="fa fa-shopping-cart" aria-hidden="true"></i><span>Sell Product</span>
                            <span class="pull-right-container">
                              <i class="fa fa-angle-right pull-right"></i>
                            </span>                       
                        </a>
                    </li>
                     <li class="<?=(($title=='Payment')?'active':'')?>">
                        <a href="<?=base_url('workstationtwo/add_payment')?>">
                            <i class="fa fa-money" aria-hidden="true"></i><span>Add Payment</span>
                            <span class="pull-right-container">
                              <i class="fa fa-angle-right pull-right"></i>
                            </span>                       
                        </a>
                    ...
                    <!--  <li class="">
                        <a href="<base_url('workstationtwo/daily_expense')?>">
                            <i class="fa fa-archive"></i><span>Expenses</span>                            
                        </a>
                    </li> -->
                    ...
                    <!-- <li class="">
                        <a href="<=base_url('workstationtwo/#')?>">
                            <i class="fa fa-archive"></i><span>Rejection Entry</span>                            
                        </a>
                    </li> -->

                     <li class="<?=(($title=='Report')?'active':'')?>">
                        <a href="<?=base_url('workstationtwo/report')?>">
                            <i class="fa fa-file"></i><span>Report</span> <span class="pull-right-container">
                              <i class="fa fa-angle-right pull-right"></i>
                            </span>                           
                        </a>
                    </li> 
                       ...
                       <li class="">
                        <a href="<=base_url('workstationthree/asset')?>">
                            <i class="fa fa-cube"></i> <span>Assets</span>                            
                        </a>
                    </li> -->
